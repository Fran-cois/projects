...
for query_size in query_size_range:
    time_,memory = get_perf(query_size=query_size)
...
for heigth in heigth_range:
    time_,memory = get_perf(max_heigth=heigth)
    time_array.append(time_)
    memory_array.append(memory)
...
for nodes in nodes_range:
    time_,memory = get_perf(number_of_node=nodes)
    time_array.append(time_)
    memory_array.append(memory)
...
for height in heigth_range:
    ...
    plt.figure(height)
    for nodes in nodes_range:
        time_,memory = get_perf(number_of_node=nodes,max_heigth=height)
        time_array.append(time_)
        memory_array.append(memory)
